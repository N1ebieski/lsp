...
$files = [
    ...
    'Exceptions/Renderer/Exception.php',
    'Exceptions/Renderer/Frame.php',
    'Exceptions/Renderer/Listener.php',
    'Exceptions/Renderer/Mappers/BladeMapper.php',
    'Exceptions/Renderer/Renderer.php',
    ...
    'Testing/WithCachedRoutes.php',
    'Testing/CachedState.php',
    'Testing/WithCachedConfig.php',
    ...
    'Http/Middleware/InvokeDeferredCallbacks.php',
    ...
    'Cloud.php',
    'Queue/InteractsWithUniqueJobs.php',
    'Queue/Queueable.php',
    ...
    'Console/JobMiddlewareMakeCommand.php',
